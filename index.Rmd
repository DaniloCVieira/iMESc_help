...
![](gif/Create%20a%20Datalist0.gif)
...
![](gif/Create_base_shape.gif){style="max-width: 50%"}
:::
...
![](gif/Summaries.gif){style="padding: 20px"}
...
![](gif/Ridges.gif){style="padding: 20px"}
...
![](gif/Scatter.gif){style="padding: 20px"}
...
![](gif/Boxplot.gif){style="padding: 20px"}
...
![](gif/PCA.gif){style="padding: 20px"}
...
![](gif/RDA.gif){style="padding: 20px"}
...
![](gif/segRDA.gif){style="padding: 20px"}
...
After choosing a Datalist, choose the Attribute (Numeric or Variable) and then the variable/factor. Optionally, filters can be applied to plot observations corresponding to a chosen factor level.

Map options include discretization (2D, 3D, 4D), interpolation (2D, Surface and Stack), and rasterization(2D, Surface and Stack).

### Discrete

-   Data palette: the observation colors;
...
::: {style="padding-left: 20px"}
Header:![](images/map_header.png){style="max- max-"}
