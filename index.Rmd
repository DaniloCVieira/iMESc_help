...
::: {style="padding-left: 20px"}
This opion allows the user to insert the example data available in iMESc. When [creating a Datalist](#create-a-datalist), choose "use example data" from the radio-button and proceed with Datalist insertion. This single action inserts two Datalists from Araçá Bay (southeastern coast of Brazil):
...
![](gif/Create%20a%20Datalist.gif){.col-sm-6}
:::
:::
...
::: {style="width: 70%"}
This drop-down button offers to the user a range of tools for editing Datalists. Among them, we highlight the **Exchange Factor/Variables** function for converting/transferring Factors to Numeric (binary or ordinal) and vice-verse.\
\
...
::: boxtext
## ![](images/split.png){style="border: 1px solid #05668D;" width="44"} Data partition
